...
#ifndef __TABLE_MAXW_H__
#define __TABLE_MAXW_H__
...
KVTemplate class maxw_table_t : public TableClass {
protected:
...
public:
  ...
  maxw_table_t(uint32 size) : TableClass(size) {
   
  }
};

#endif // __TABLE_MAXW_H__
